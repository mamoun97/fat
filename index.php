...
?>
        ...
        <section class="directorate-section">
            <div class="directorate-header">
                <div class="definition">
                    <h2>تعريف المديرية</h2>
                    <p>مديرية ذوي الاحتياجات الخاصة هي الجهة المسؤولة عن تقديم الدعم والخدمات للأشخاص ذوي الاحتياجات
                        الخاصة في المجتمع، لضمان حياة كريمة ومتكاملة لهم. تهدف إلى تعزيز الاندماج الاجتماعي وتوفير فرص
                        متساوية.</p>
                </div>
                <img src="styles/cover.jpeg" alt="صورة لمبنى حكومي"
                    height="300">
            </div>
            <div class="role">
                <h3>دور المديرية</h3>
