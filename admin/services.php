...
hearing_impairment,handicap_helps,
visual_impairment,
motor_disability, disability_file, birth_date,note, status FROM users where `type`='subvention'");
$users = $stmt->fetchAll(PDO::FETCH_ASSOC);

$stmt2 = $pdo->query("SELECT * FROM users where `type`='subvention' and status in (0, 3)" );
$not = ($stmt2->fetchAll(PDO::FETCH_ASSOC));

?>


<?php showHeader("services"); ?>
